...
// type PaymentMethod = "stripe" | "free" | "cashfree";
...
//     console.log(`Creating Cashfree order for ${productType}:`, productId);

//     const res = await fetch(
//       "https://rxyfrjfgydldjdqelixe.supabase.co/functions/v1/create-cashfree-order",
//       {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
...
//         },
//         body: JSON.stringify({
//           seminar_id: productType === "seminar" ? productId : null,
//           course_id: productType === "course" ? productId : null,
//           user_id: session.user.id,
//           amount: price,
//           currency: "INR",
//           return_url: `${window.location.origin}/${productType}/${productId}?payment=success&provider=cashfree`,
//           notify_url:
//             "https://rxyfrjfgydldjdqelixe.supabase.co/functions/v1/cashfree-webhook",
//         }),
//       }
//     );
...
//   const handlePaidEnrollment = async (method: string) => {
