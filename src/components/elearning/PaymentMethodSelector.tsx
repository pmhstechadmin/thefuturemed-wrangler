...
//     {
//       id: "cashfree",
//       name: "Credit/Debit Card - Cashfree",
//       icon: Wallet,
//       description: "Pay securely via Cashfree payment gateway",
//     },
//   ];
...
//       mixpanelInstance.track(
//         "Continue to Payment (Cashfree) seminar Enrolled Secondary Button Clicked",
//         {
//           timestamp: new Date().toISOString(),
//         }
//       );
