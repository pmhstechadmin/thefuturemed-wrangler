  ...
  < div className = "container mx-auto px-4 py-6" >
    <Tabs defaultValue="blog-list" className="w-full">
      <TabsList className="grid w-full grid-cols-2 mb-6">
        <Link
          to="/blog-portal"
          className={`flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium rounded-sm transition-all ${isBlogList ? "bg-white text-black shadow" : "hover:bg-muted"
            }`}
        >
          <Building className="h-4 w-4" />
          Blog List
        ...
        <Link
          to="/post-blog"
          className={`flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium rounded-sm transition-all ${isPostBlog ? "bg-white text-black shadow" : "hover:bg-muted"
            }`}
        >
          <Building className="h-4 w-4" />
          Post Blog
