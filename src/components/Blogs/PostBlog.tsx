...
//       } else if (shouldRedirect && timer === 0) {
//         navigate("/my-blogs");
//       }
//       return () => clearTimeout(countdown);
//     }, [shouldRedirect, timer, navigate]);
...
const PostBlog: React.FC<{ onBlogPosted: () => void }> = ({ onBlogPosted }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // ✅ Replace base64 embedded image with uploaded Supabase URL
    ...
    if (base64Match && base64Match[1]) {
      ...
      const fileName = `${Date.now()}-blog.${fileType}`;
      ...
      if (!uploadError) {
        ...
        // ✅ Replace base64 with Supabase image URL
