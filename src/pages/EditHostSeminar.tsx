            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    value={
                      Object.keys(seminarTypeMap).find(
                        (key) =>
          ...
          <Card>
            <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label className="text-base font-medium text-green-800">
                      Enrollment Type (Free/Paid) *(The minimum price is $0.50 /
                      INR 50 per registration.)
                    </Label>
              ...
              <div className="flex items-center justify-between mt-4">
                <div>
                  <Label className="text-base font-medium text-green-800">
                    Include Certificate* (Default Template Provided) View Sample
                    Certificate
                  </Label>
                  <p className="text-sm text-green-600 mt-1">
                    <b>Status:</b>{" "}
                  ...
                  <p className="text-xs text-green-500 mt-1">
                    To provide customized certificate template, please email us
                    at drshan@thefuturemed.com
                  </p>
                </div>
